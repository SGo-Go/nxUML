...
def write_versionfile():
    ...
    text = '''"""
Version information for DoxyUML, created during installation.
...
# Was DoxyUML built from a development version? If so, remember that the major
...
def get_info(dynamic=True):
    ...
    if dynamic_failed or not dynamic:
        # This is where most final releases of DoxyUML will be.
...
long_description = \
"""
DoxyUML is a Python package for creation of 
the UML class diagrams from C++ sources.

"""
license = '@TODO'
authors = {'Gogolenko' : ('Sergiy Gogolenko','sergiy.gogolenko@gmail.com')}
maintainer = "DoxyUML Developers"
platforms = ['Linux','Mac OSX','Windows','Unix']
keywords = ['UML', 'C++ codes',]
classifiers = [
